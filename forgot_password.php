...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($step == 1) {
        ...
        if ($check && $check->num_rows > 0) {
            ...
            // THỬ GỬI EMAIL (Nếu localhost không có cấu hình mail, hệ thống sẽ hiện thẳng OTP ra màn hình để test)
            ...
            $msg = "Mã OTP đã được gửi đến Email của bạn! (Dành cho Giảng viên chấm điểm Localhost: Mã OTP là <b>$otp</b>)";
            $msg_type = "success";
...
<body>
    <div class="auth-box">
        <h2 style="color: var(--primary-color); margin-top:0;"><i class="fa fa-unlock-alt"></i> Khôi phục mật khẩu</h2>
